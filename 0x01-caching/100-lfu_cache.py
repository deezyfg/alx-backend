...
class LFUCache(BaseCaching):
    ...
    Attributes:
        cache_data (OrderedDict): Stores the cached data with insertion order.
        keys_freq (list): A list to track the frequency of access for each key.
    """
    def __init__(self):
        """
