...
This project focuses on implementing a queuing system in JavaScript using modern technologies and frameworks. It covers the fundamentals of queue management, job processing, and asynchronous task handling in a Node.js environment. The project uses Redis as a backend data store, Express.js for creating API endpoints, and Kue as a priority job queue system.
...
```
{
  ...
  "version": "1.0.0",
  "description": "A Node.js project demonstrating queuing system implementation using Express, Redis, and Kue.",
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/deezyfg/alx-backend"
  },
  "bugs": {
    "url": "https://github.com/deezyfg/alx-backend/issues"
  },
  "homepage": "https://github.com/deezyfg/alx-backend/blob/master/0x03-queuing_system_in_js/README.md",
  "engines": {
    "node": "16.x",
    "npm": "8.x",
    "yarn": "1.x"
...
* Using the Redis client again, set the value `School` for the key 
`Holberton`
```
